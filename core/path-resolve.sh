#!/usr/bin/env sh
# ~/.config/packedbox/core/path-resolve.sh
...
PATH_CONTRACT="${PATH_CONTRACT:-$PACKEDBOX_ROOT/core/path.contract}"
LOCAL_PATH_CONTRACT="${LOCAL_PATH_CONTRACT:-$PACKEDBOX_ROOT/local/path.contract}"
TOOL_CONTRACT="${TOOL_CONTRACT:-$PACKEDBOX_ROOT/core/tool.contract}"
