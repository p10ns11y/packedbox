-- packedbox eye-comfort-dark — standalone Neovim colorscheme (no plugin manager).
-- Installed as ~/.config/nvim/colors/packedbox.lua by packs/terminal/install.sh.
